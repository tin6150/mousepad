...
LABEL org.opencontainers.image.source="https://github.com/tin6150/mousepad"
LABEL UPSTREAM_AUTHOR="https://docs.xfce.org/apps/mousepad/start"
...
RUN echo  ''  ;\
    ...
    apt-get update ;\  
    echo "installing packages via yum"       | tee -a _TOP_DIR_OF_CONTAINER_  ;\
...
RUN  cd / \
  ...
  && echo  "Dockerfile      2024.0420"   >> _TOP_DIR_OF_CONTAINER_   \
  && echo  "Grand Finale for Dockerfile"

ENV DBG_APP_VER  "Dockerfile 2024.0420"
